...
namespace WpfMvvmStability.Models.DAL
{
    class clsDBUtilityMethods
    {
        ...
        public static DataTable GetSPTable(DbCommand command, String ErrorMessage)
        {
            ErrorMessage = String.Empty;
            DataTable dtable = new DataTable();
            DbTransaction tran = null;
       ...
       /// <returns>Returns a DbCommand object.</returns> 
        ...
        public static Int32 ExecuteNonQuery(DbCommand command, String ErrorMessage)
        {
            ...
            try
            {
                ...
                conn.Open();
                //CommandTimeout cmdtmt = command.CommandTimeout;
                tran = conn.BeginTransaction();
                command.Transaction = tran;
        ...
        public static Int32 ExecuteNonQuery1(DbCommand command, String ErrorMessage)
        {
            ErrorMessage = String.Empty;
            DbTransaction tran = null;
            DbConnection conn = null;
